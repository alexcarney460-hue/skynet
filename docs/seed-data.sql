...
-- Link artifacts to pack (in a logical order)
INSERT INTO pack_items (pack_id, artifact_id, sort_order) VALUES
((SELECT id FROM packs WHERE slug = 'complete-agent-system'),
 (SELECT id FROM artifacts WHERE slug = 'reasoning-chain-prompt'), 1),
((SELECT id FROM packs WHERE slug = 'complete-agent-system'),
 (SELECT id FROM artifacts WHERE slug = 'ephemeral-memory-system'), 2),
((SELECT id FROM packs WHERE slug = 'complete-agent-system'),
 (SELECT id FROM artifacts WHERE slug = 'tool-orchestration-framework'), 3),
((SELECT id FROM packs WHERE slug = 'complete-agent-system'),
 (SELECT id FROM artifacts WHERE slug = 'agent-diagnostics-kit'), 4),
((SELECT id FROM packs WHERE slug = 'complete-agent-system'),
 (SELECT id FROM artifacts WHERE slug = 'prompt-evaluation-suite'), 5),
((SELECT id FROM packs WHERE slug = 'complete-agent-system'),
 (SELECT id FROM artifacts WHERE slug = 'fast-inference-pattern'), 6);
